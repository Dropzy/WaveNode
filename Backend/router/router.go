...
func (r *Router) SetupRoutes() *mux.Router {
	...
	protected.HandleFunc("/audiobooks/search", r.searchAudiobooks).Methods("GET", "OPTIONS")
	protected.HandleFunc("/audiobooks/home", r.getAudiobookHome).Methods("GET", "OPTIONS")
	protected.HandleFunc("/audiobooks/progress", r.updateAudiobookProgress).Methods("PUT", "OPTIONS")
	protected.HandleFunc("/audiobooks/{id}", r.getAudiobook).Methods("GET", "OPTIONS")
